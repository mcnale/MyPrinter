...
namespace myPrinter
{
    ...
    public class DataGridPrinter
    {
        ...
        int headerHeight = 80; // SIZE OF BOXLINE
        ...
        public void DrawReportHeader(Graphics g)
        {
            if (RHeader != null)
            {
                g.FillRectangle(new SolidBrush(Color.White), 50, TopMargin, PageWidth - 100, TopMargin + headerHeight - 10);
                g.DrawRectangle(new Pen(Color.Black), 50, TopMargin, PageWidth - 100, TopMargin + headerHeight - 250); // HEADER BOXLINE
        ...
        public void DrawHeader(Graphics g)
        {
            ...
            cellformat.Alignment = (isRTL) ? StringAlignment.Center : StringAlignment.Center;
        ...
        public bool DrawRows(Graphics g)
        {
            ...
            //  try
            {
                ...
                for (int i = initialRowCount; i < TheDataGrid.Rows.Count; i++)
                {
                    ...
                    {
                        g.FillRectangle(new SolidBrush(Color.White), RowBounds);
                    }
        ...
        public void DrawReportFooter(Graphics g, int bottomY)
        {
            if (RFooter != null)
            {
                g.FillRectangle(new SolidBrush(Color.White), 30, bottomY + 10, PageWidth - 60, 30);
